...
export default function ResumeUpload() {
  ...
  return (
    <div className="bg-surface-container-low p-6 rounded-[1.5rem] ambient-shadow border border-ghost w-full max-w-md">
      ...
      <div className="border-2 border-dashed border-outline-variant/30 rounded-[1rem] p-8 text-center mb-6">
        <input 
          type="file" 
          id="resume" 
          className="hidden" 
