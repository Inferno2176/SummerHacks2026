    ...
    <div className="flex-1 bg-surface min-h-[calc(100vh-4.5rem)] flex flex-col">
      <main className="flex-1 p-8 xl:p-12 max-w-7xl mx-auto w-full pb-32">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          ...
          <button className="bg-gradient-to-br from-primary to-primary-container text-on-primary rounded-2xl py-4 px-8 font-black text-xs uppercase tracking-widest shadow-lg shadow-primary/20 hover:shadow-xl hover:scale-[1.02] transition-all flex items-center justify-center gap-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {letters.map((letter) => (
            <div key={letter.id} className="bg-white rounded-3xl p-7 flex flex-col relative group transition-all hover:-translate-y-1 ambient-shadow border border-outline-variant/10">
              <div className="absolute top-7 right-7 flex space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                ...
                <button className="text-on-surface-variant hover:text-error transition-colors p-2 rounded-full hover:bg-error/5">
              ...
              <div className="mt-auto flex items-center justify-between pt-4 border-t border-outline-variant/5">
                ...
                <span className="text-[10px] font-black text-on-surface-variant uppercase tracking-widest bg-surface-container-highest/50 px-3 py-1.5 rounded-lg">
                  {letter.type}
                </span>
              </div>
            </div>
