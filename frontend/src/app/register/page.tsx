      ...
      <div className="w-full min-h-screen flex flex-col lg:flex-row items-stretch bg-surface-container-lowest overflow-hidden z-10 relative">
        ...
        <div className="hidden lg:flex w-[55%] relative bg-surface-container-low p-12 xl:p-16 flex-col justify-between overflow-hidden">
          ...
          <div className="z-10 relative mt-auto mb-12">
            <h2 className="font-manrope text-5xl xl:text-6xl font-black leading-tight mb-6 mt-2">
              <span className="text-white drop-shadow-md">Begin Your</span><br/>
              <span className="text-[#8e90ff] drop-shadow-[0_0_15px_rgba(142,144,255,0.5)] mt-2 block">Digital Sanctuary</span>
            </h2>
            <p className="font-body text-white/90 text-xl font-medium leading-relaxed max-w-md drop-shadow-md">
              Curate your active applications, automate your follow-ups, and design your ultimate career ecosystem.
            </p>
          </div>
          ...
          <div 
            ...
            style={{
              backgroundImage: "url('https://images.unsplash.com/photo-1521737604893-d14cc237f11d?auto=format&fit=crop&q=80&w=2084')",
        ...
        <div className="w-full lg:w-[45%] p-8 sm:p-10 md:p-12 xl:px-20 xl:py-10 flex flex-col justify-center bg-surface-container-lowest">
          ...
          <div className="mb-6 text-center lg:text-left">
            <h1 className="font-manrope text-3xl font-bold text-on-surface mb-3">Create Account</h1>
          ...
          <form className="space-y-6" onSubmit={handleRegister}>
            {/* Full Name */}
            <div>
              <label className="block font-body text-sm font-medium text-on-surface mb-2" htmlFor="fullName">Full Name</label>
            ...
            {/* Password */}
            <div>
              <label className="block font-body text-sm font-medium text-on-surface mb-2" htmlFor="password">Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-outline">
          ...
          <div className="mt-6 flex items-center justify-between">
            ...
            <span className="font-body text-xs text-outline-variant uppercase tracking-wider font-semibold text-center w-3/5 lg:w-1/2">Or continue with</span>
            <span className="w-1/5 border-b border-outline-variant/20 lg:w-1/4"></span>
          </div>
          ...
          <p className="mt-5 text-center font-body text-sm text-on-surface-variant">
            ...
            <Link className="font-semibold text-primary hover:text-primary-dim transition-colors ml-1" href="/login">Sign in</Link>
          </p>
        </div>
      </div>
    </div>
