  ...
  return (
    <main className="flex-1 flex overflow-hidden bg-surface relative h-[calc(100vh-4.5rem)]">
      ...
      <div className="w-full md:w-[400px] lg:w-[450px] border-r border-surface-container-high/50 flex flex-col h-full bg-surface-bright z-10 shadow-[20px_0_40px_rgba(44,52,55,0.02)]">
        ...
        <div className="p-6 pb-4">
          <div className="flex justify-between items-baseline mb-4">
            ...
            <span className="text-xs font-label text-outline bg-surface-container-high px-2 py-1 rounded-full text-slate-500">3 New</span>
          </div>
          <div className="flex space-x-2 overflow-x-auto pb-2 no-scrollbar">
            <button className="px-4 py-1.5 bg-primary-fixed/20 text-primary-dim font-label text-xs font-semibold rounded-full whitespace-nowrap">All Items</button>
            <button className="px-4 py-1.5 bg-surface-container text-on-surface-variant font-label text-xs font-medium rounded-full whitespace-nowrap border border-outline-variant/20">Urgent</button>
            <button className="px-4 py-1.5 bg-surface-container text-on-surface-variant font-label text-xs font-medium rounded-full whitespace-nowrap border border-outline-variant/20">Newsletters</button>
          </div>
        </div>
        ...
        <div className="flex-1 overflow-y-auto px-4 pb-6 space-y-3 no-scrollbar">
          {/* Card 1 (Active) */}
          <div className="bg-surface-container-lowest p-5 rounded-[1.5rem] shadow-[0px_20px_40px_rgba(44,52,55,0.06)] relative overflow-hidden group cursor-pointer border border-primary-container/20">
            ...
            {/* AI Badge */}
            <div className="bg-primary-fixed/10 p-3 rounded-xl mb-3 flex items-start space-x-2 border border-primary-fixed/20">
          ...
          {/* Card 2 */}
          <div className="bg-surface-container-lowest/60 hover:bg-surface-container-lowest p-5 rounded-[1.5rem] transition-colors relative group cursor-pointer border border-outline-variant/15">
            <div className="flex justify-between items-start mb-3">
              <div className="flex items-center space-x-3">
            ...
            <div className="bg-surface-container p-3 rounded-xl mb-3 flex items-start space-x-2">
      ...
      <div className="hidden md:flex flex-1 flex-col bg-surface-container-low/30 p-8 relative">
        <div className="bg-surface-container-lowest rounded-[2rem] p-8 shadow-[0px_20px_40px_rgba(44,52,55,0.04)] mb-6 flex-1 overflow-y-auto no-scrollbar">
          <div className="flex justify-between items-start mb-6">
            ...
            <div className="flex space-x-3">
              <button className="p-2 rounded-full border border-outline-variant/20 text-on-surface-variant hover:bg-surface-container transition-colors">
                <span className="material-symbols-outlined">more_horiz</span>
              </button>
              <button className="p-2 rounded-full bg-surface-container text-on-surface-variant hover:text-error transition-colors">
        ...
        <div className="bg-surface-container-lowest/80 backdrop-blur-xl rounded-[2rem] p-6 shadow-[0px_-10px_40px_rgba(44,52,55,0.05)] border border-outline-variant/10 flex items-center space-x-4">
          <button className="px-6 py-4 rounded-full bg-primary bg-gradient-to-br from-primary to-primary-container text-on-primary font-label font-bold flex items-center space-x-2 shadow-[0px_10px_20px_rgba(74,75,215,0.2)] hover:scale-[1.02] transition-transform">
            <span className="material-symbols-outlined">auto_awesome</span>
            <span>Reply with AI</span>
          </button>
          <div className="flex-1 px-6 py-4 bg-surface-container rounded-full border border-outline-variant/20 text-on-surface-variant font-body text-sm flex items-center justify-between cursor-text">
