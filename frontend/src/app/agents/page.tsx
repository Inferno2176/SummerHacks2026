  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-center p-10 bg-surface">
      <div className="text-center space-y-6 max-w-2xl">
        <div className="w-24 h-24 bg-primary-fixed/20 rounded-3xl flex items-center justify-center mx-auto text-primary">
        ...
        <div className="pt-6">
          <button className="px-8 py-3 bg-primary text-on-primary rounded-full font-label font-medium hover:bg-primary-dim transition-all shadow-[0_8px_16px_rgba(74,75,215,0.2)]">
